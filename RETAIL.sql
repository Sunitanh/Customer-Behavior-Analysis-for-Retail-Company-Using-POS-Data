...
-----As first steps,pls convert the date variables into valid date formuts before proceeding ahead.

SELECT CONVERT(DATE,DOB,105) AS DATE_OF_BIRTH
FROM Customer;

--Q4.What is the time range of the transction data available for analysis?
...
--Q1.Which channel is most frequently used for transcations?
...
--Q13.Which store-type sells maximum products;by the value of sales amount and by quantity sold?
